...
Reply with ONLY this JSON shape:
{
  ...
  "coverArtPrompt": "cover illustration direction: the single most magical moment of THIS story — the child mid-action at their happiest, framed like a picture-book cover a kid would grab off the shelf. Compose with the child in the MIDDLE of the frame and keep the UPPER-RIGHT corner and the BOTTOM QUARTER free of faces and key objects (a series badge is printed top-right and the title band covers the bottom). No text in image",
