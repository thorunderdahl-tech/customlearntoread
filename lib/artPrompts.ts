...
export function pagePrompt(scene: string, characterDescription: string, cast?: string, directorNote?: string, fixNotes?: string, editPrevious = false): string {
  const companionLine = cast
